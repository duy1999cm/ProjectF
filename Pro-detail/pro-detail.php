        ...
        <div class="row header">
            ...
            <?php
                    if(isset($_SESSION['user_id'])){
                        ...
                        <a href="../User-main/User-main.php" class="float-right mt-0">'.$_SESSION['name'].'</a>
                        ';
                    }else{
                        echo '
                ...
                <div class="row ">
                    ...
                    <div class="col-md-5 mt-3 ">
                        ...
                        <div class="add_cart mt-5">
                                <a href="muacart.php?id='.$idpro.'"><button class="btn btn-warning pro_btn">MUA SẢN PHẨM NGAY <br> Giao hàng nhanh</button></a>
                    ...
                    <div class="col-md-4 mt-3 title-pro ">
                        <div class="conatainer">
                            <div class="title mb-3 text-center">
                                <span>CÁC SẢN PHẨM CÙNG DANH MỤC</span>
                            </div>
                        </div>
                    </div>
                </div>
