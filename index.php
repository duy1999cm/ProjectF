                        ...
                        <ul class="font-list">
                            <?php
                                foreach($cate as $items){
                                    echo '
                                    <li><a style="text-decoration: none; color: white" href="?id='.$items['cate_id'].'">'.$items['cate_name'].'</a></li>
                                    ';
                                }
                            ?>
